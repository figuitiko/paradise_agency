...
<nav class="navbar navbar-default navbar-fixed-top">
    ...
    <div class="container">
        ...
        <div class="navbar-header page-scroll">
            ...
            <div class="navbar-brand page-scroll"><a href="#page-top"><?php bloginfo('name')?>  </a><br><small><?php bloginfo('description')?></small></div>
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="embed-responsive embed-responsive-4by3">
                <!--<iframe class="embed-responsive-item" src="//www.youtube.com/embed/3A4P_T3ukpo" si></iframe>-->
               <!-- <iframe src="https://www.youtube.com/embed/3A4P_T3ukpo?controls=0&showinfo=0&rel=0&autoplay=1&loop=1&playlist=W0LHTWG-UmQ" frameborder="0" allowfullscreen></iframe>-->
            </div>
        </div>
    </div>
